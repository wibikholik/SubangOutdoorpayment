      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
          <ul class="nav navbar-nav menu_nav ml-auto">
            <li class="nav-item mx-2 <?= $currentPage == '../index.php' ? 'active' : '' ?>">
              <a class="nav-link" href="../../index.php">Home</a>
            </li>
            <li class="nav-item mx-2 <?= $currentPage == 'produk.php' ? 'active' : '' ?>">
              <a class="nav-link" href="produk.php">Produk</a>
            </li>
            <li class="nav-item mx-2 <?= in_array($currentPage, ['transaksi.php', 'pembayaran.php', 'booking.php']) ? 'active' : '' ?>">
              <a class="nav-link" href="../page/transaksi.php">Penyewaan</a>
            </li>
            <li class="nav-item mx-2 <?= $currentPage == 'bantuan.php' ? 'active' : '' ?>">
            ...
            <li class="nav-item dropdown mx-2">
              <a class="nav-link dropdown-toggle d-flex align-items-center user-dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
