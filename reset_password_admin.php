...
if (!isset($_SESSION['otp_verified_admin']) || !$_SESSION['otp_verified_admin']) {
    ...
    if ($password !== $confirm) {
        ...
        if (empty($email)) {
            ...
            if ($stmt->execute()) {
                ...
                session_destroy();
                session_start();
                $_SESSION['success_message'] = "Password admin berhasil direset.";
...
<body>
    <div class="container">
        <h2>Atur Password Baru Admin</h2>
        <?php if ($message): ?>
